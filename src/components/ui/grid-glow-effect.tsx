...
interface GlowingEffectProps {
  ...
  proximity?: number;
  spread?: number;
  variant?: "default" | "white" | "blue-purple" | "gold";
  glow?: boolean;
  className?: string;
  disabled?: boolean;
...
const gradients = {
  ...
  gold: `radial-gradient(circle at 20% 20%, rgba(212, 175, 55, 0.5) 0%, transparent 30%),
         radial-gradient(circle at 80% 20%, rgba(230, 200, 77, 0.4) 0%, transparent 30%),
         radial-gradient(circle at 20% 80%, rgba(196, 154, 44, 0.4) 0%, transparent 30%),
         radial-gradient(circle at 80% 80%, rgba(212, 175, 55, 0.5) 0%, transparent 30%),
         repeating-conic-gradient(
           from calc(var(--start) * 1deg) at 50% 50%,
           rgba(212, 175, 55, 0.95) 0%,
           rgba(230, 200, 77, 1) calc(25% / var(--repeating-conic-gradient-times)),
           rgba(196, 154, 44, 0.95) calc(50% / var(--repeating-conic-gradient-times)),
           rgba(212, 175, 55, 0.95) calc(75% / var(--repeating-conic-gradient-times)),
           rgba(184, 148, 31, 0.9) calc(100% / var(--repeating-conic-gradient-times))
         )`,
};
      ...
      <>
        ...
        <div
          className={cn(
            ...
            variant === "gold" && "border-gold-400/30",
            disabled && "!block"
          )}
        />
        {/* Glow container */}
          ...
          <div
            className={cn(
              ...
              variant === "gold" && [
                ...
                "before:bg-gradient-to-r before:from-gold-400/10 before:via-gold-300/10 before:to-gold-500/10",
